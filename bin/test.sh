...
#   # Call the check_conflicts function
#   gitmini check_conflicts

#   # Check that conflicts are detected
#   conflicts=$(git grep -l -Ee '<<<<<<<|=======|>>>>>>>')
#   assert "conflict.txt" "$conflicts" "check_conflicts should detect conflicts in the codebase"
